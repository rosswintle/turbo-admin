(() => {
  ...
  var ContentApi = class {
    ...
    async getPosts(searchString) {
      if (this.cache[searchString] !== void 0) {
  ...
  var TurboAdminPalette = class {
      ...
      if (contentItems.length > 0) {
        contentItems.forEach((item) => {
          ...
          if (oxygenLinkElem) {
            ...
            const subMenuItem32 = document.createElement("li");
            const subMenuLink32 = document.createElement("a");
            subMenuLink32.innerText = "Edit with Oxygen";
            subMenuLink32.href = oxygenLink;
            subMenuItem32.appendChild(subMenuLink32);
            subMenuItems.appendChild(subMenuItem32);
          }
    ...
    async debouncedPaletteSearchAndUpdate() {
      if (this.paletteInputElement.value !== "" && this.paletteInputElement.value.length <= 2 || this.postTypes === []) {
    ...
    async paletteSearch() {
      ...
      if (globalThis.contentApi.active && this.postTypes !== [] && this.paletteInputElement.value.length > 2) {
        ...
        globalThis.contentApi.getPosts(this.paletteInputElement.value).then((results) => {
  ...
  // src/class-turbo-admin-barkeeper.js
  var TurboAdminBarkeeper = class {
  ...
  var TurboAdmin = class {
    ...
    async init() {
      ...
      if (this.options["barkeeper"] === true) {
        if (typeof browser !== "object") {
          this.options["barkeeper-state"] = window.localStorage.getItem("turboAdminBarkeeperState");
        }
        this.turboAdminBarkeeper = new class_turbo_admin_barkeeper_default(this.options["barkeeper-state"]);
      }
